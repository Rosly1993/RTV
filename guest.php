...
//   $check_if_lock = $conn->query("select * from tbl_user where user_name='$user_name' and lock > 5 ")->num_rows ;
...
if(empty($user_name_err) && empty($password_err)){
  ...
  if(is_array($row))
  {
      ...
      $update = $conn->query("UPDATE `tbl_user` set `active_now` = '1'  where id = '{$id_1}'");
...
//   $user_name_err = "Your Account Has Been Locked";
// }
              ...
              <div class="card card-plain">
                ...
                <div class="card-body">
                  <form role="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method='POST'>
                    ...
                    <div class="mb-3">
                      <input type="text" class="form-control form-control-lg" placeholder="Username" name='user_name'aria-label="Username"  value="guest" readonly>
                    </div>
                    <div class="mb-3">
                      <input type="password" class="form-control form-control-lg" placeholder="Password" name='password' aria-label="Password"  value="guest" readonly>
                    </div>
