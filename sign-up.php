...
if(empty($user_name_err) && empty($password_err)){
  ...
  if($check_if_exist > 0)
  {
    $user_name_err = "Username Already Exist";

  } elseif ($user_name === $password) {

    $user_name_err = "Username and password cannot be the same. Please choose different ones.";
      
  }else{
  
      $query = $conn->query("INSERT INTO `tbl_user` (`name`,`user_name`,`password`,`area`,`user_role`,`is_active`,`email_address`,`profile`) VALUE ('{$name}','{$user_name}','{$password}','{$area}','{$user_role}','0','{$email_address}','PROFILE.png')");
      include('./mail/sign_up.php');
      $user_name_err = "Successfully Register Please Wait for Your Account Activation";
...
<body class="">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navigation">
        ...
        <ul class="navbar-nav d-lg-block d-none">
          <li class="nav-item">
            <a href="./docs/Manual.pdf" target='_blank' class="btn btn-sm mb-0 me-1 bg-gradient-light"> Download User's Manual</a>
          </li>
        </ul>
      </div>
    </div>
  ...
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('./assets/img/login_bg.jpg'); background-position: top;">
      <span class="mask bg-gradient-dark opacity-6"></span>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            <h1 class="text-white mb-2 mt-5">Welcome!</h1>
            <p class="text-lead text-white">Use these awesome forms to  create your new account.</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              ...
              <center><div class="form-group mb-3"><span class="text-danger"><?php echo $user_name_err; ?></span></div></center>
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Name" aria-label="Name" name='name' required autocomplete='off'>
                </div>
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Username" aria-label="Username" name='user_name' required autocomplete='off'>
                </div>
                <div class="mb-3">
                  <input type="password" class="form-control" placeholder="Password" aria-label="Password" name='password' required autocomplete='off' pattern="(?=.*\d)(?=.*[A-Za-z])[A-Za-z0-9]+" 
            title="Password must contain at least one letter and one number" 
            minlength="5" data-toggle="password" />
                </div>
                <div class="mb-3">
                  <input type="email" class="form-control" placeholder="Email" aria-label="Email" name='email_address' required  autocomplete='off'>
                </div>
                <div class="mb-3">
                  <select type="select" class="form-control" placeholder="Area" aria-label="Area" name='area' required autocomplete='off'>
                ...
                <div class="mb-3">
                  <select type="select" class="form-control" placeholder="User Role" aria-label="User Role" name='user_role' required autocomplete='off'>
                ...
                <div class="text-center">
                  <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2" name='save'>Sign up</button>
                </div>
      ...
      <div class="row">
        <div class="col-8 mx-auto text-center mt-1">
          <p class="mb-0 text-secondary">
            ...
            </script> Soft by System Engineering.
          </p>
        </div>
      </div>
    </div>
