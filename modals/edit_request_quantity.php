        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Request Quantity</h5>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <div class="row"> 
                            ...
                            <div class="form-group col-6 col-md-6  col-sm-6">
                                <label for="loaction" class="control-label">Defect Loaction</label>
                                <input type="text" class="form-control input-lg" id="location" name="location" onkeyup="this.value = this.value.toUpperCase()" autocomplete="off" readonly>    
                            </div> <div class="form-group col-6 col-md-6  col-sm-6">
                                <label for="description" class="control-label">Defect Description</label>
                                <input type="text" class="form-control input-lg" id="description" name="description" onkeyup="this.value = this.value.toUpperCase()" autocomplete="off" readonly>    
                            </div>
                            <div class="form-group col-12 col-md-12  col-sm-12">
                            <label for="qty" class="control-label">Quanity</label>
                                <input type="number" class="form-control input-lg" id="qty" name="qty" onkeyup="this.value = this.value.toUpperCase()" min='1' autocomplete="off" autocomplete='off'>    
                            </div>
