        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Warehouse Information</h5>
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <div class="row"> 
                            ...
                            <div class="form-group col-6 col-md-6  col-sm-6">
                                <label for="qty" class="control-label">Total Quantity</label>
                                <input type="text" class="form-control input-lg" id="qty" name="qty" placeholder='Enter IS Number Here' onkeyup="this.value = this.value.toUpperCase()" autocomplete="off" readonly>    

                            </div>
                           
                            <div class="form-group col-6 col-md-6  col-sm-6">
                                <label for="is_number" class="control-label">IS Number</label>
                                <input type="text" class="form-control input-lg" id="is_number1" name="is_number" placeholder='Enter IS Number Here' onkeyup="this.value = this.value.toUpperCase()" autocomplete="off" readonly>    

                            </div>
                           
                            <div class="form-group col-6 col-md-6  col-sm-6">
                                <label for="status_w" class="control-label">Judgement</label><span style='color:red'>*</span>
                                <select type="text" class="form-control input-lg" id="status_w" name="status_w" placeholder='Enter IS Number Here' onkeyup="this.value = this.value.toUpperCase()" autocomplete="off" required>  
                                <option value=''>Select </option>  
                                <option value='11'>Approve</option>  
                                <option value='18'>Reject</option>  
                                </select>

                            </div>
                            <div class="form-group col-6 col-md-6  col-sm-6">
                                <label for="remarks" class="control-label">Remarks</label>
                                <input type="text" class="form-control input-lg" id="warehouse_remarks" name="warehouse_remarks" placeholder='Remarks(Optional)' onkeyup="this.value = this.value.toUpperCase()" autocomplete="off" >    
