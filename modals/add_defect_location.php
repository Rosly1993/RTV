        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Defect Location</h5>
                    ...
                    <div class="container-fluid">
                        <form action="" id="new_model"   enctype="multipart/form-data">
                            ...
                            <div class="form-group col-12 col-md-12  col-sm-12">
                                <label for="location" class="control-label">Defect Location</label><span style="color:red">*</span>
                                <input type="text" class="form-control input-lg" id="location" name="location" placeholder="Enter Defect Location Here" onkeyup="this.value = this.value.toUpperCase()"   required autocomplete="off"> 
