                        ...
                        <form action="" id="new_model"   enctype="multipart/form-data">
                            <div class="row">
                             ...
                             <div class="form-group col-12 col-md-12  col-sm-12">
                                ...
                                <input type="text" class="form-control input-lg" id="model" name="model" placeholder="Enter Model Name Here" onkeyup="this.value = this.value.toUpperCase()" required autocomplete="off"> 
