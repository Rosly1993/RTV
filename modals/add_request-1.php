                    ...
                    <div class="container-fluid">
                        <form action="" id="new_model"   enctype="multipart/form-data">
                            ...
                            <div class="form-group col-4 col-md-4  col-sm-4">
                                ...
                                <input type="number"style="width:100%;" min="1" class="form-control input-lg" id="qty" name="qty[]" placeholder="Enter NG Qty. Here" onkeyup="this.value = this.value.toUpperCase()" required autocomplete="off"> 
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
            ...
            function addItem() {
                ...
                html +='<div class="form-group col-3 col-md-3 col-sm-3">';
                
                html +='<input class="form-control input-lg" type="number" min="1"  name="qty[]" placeholder="Enter Qty. Here" required="" autocomplete="off">';
                html +='</div>';
                
                html +='<div class="form-group col-1 col-md-1 col-sm-1">';
                
                html +="<button type='button' onClick='deleteRow(this);'  class='btn bg-gradient-secondary' ><i class='ni ni-settings'></i></button>";
