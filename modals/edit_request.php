                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row"> 
                            ...
                            <div class="form-group col-12 col-md-12  col-sm-12">
                                <label for="reason" class="control-label">Reason of Cancellation</label><span style='color:red'>*</span>
                                <input type="text" class="form-control input-lg" id="reason" name="reason" placeholder='Enter Reason Here' onkeyup="this.value = this.value.toUpperCase()" autocomplete="off" required>    
