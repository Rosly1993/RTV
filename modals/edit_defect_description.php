        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Description Defect</h5>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row"> 
                            ...
                            <div class="form-group col-12 col-md-12  col-sm-12">
                                <label for="description" class="control-label">Description Defect</label>
                                <input type="text" class="form-control input-lg" id="description1" name="description" onkeyup="this.value = this.value.toUpperCase()" autocomplete="off" >    
                            </div>
