...
$query_table=mysqli_query($conn, "SELECT
                            ...
                            ?> 
 <?php
$query_page1=mysqli_query($conn, "SELECT * from tbl_pages where page_name='Mfi_Med' ");
          ...
          <div class="card ">
            <div class="card-header pb-0 p-3">
              <div class="d-flex justify-content-between">
                <h6 class="mb-2">For Note MFI-MED Info Table</h6>
              </div>
            </div>
            ...
            <table  id="myTable" class="table align-items-center mb-0"  width="100%" cellspacing="0">
                  ...
                  <?php while($row4=mysqli_fetch_array($query_table)){ ?>  
                    ...
                    <tr>
                          ...
                          <td class="px-1 py-1 text-center"><a href="noted_mfi_med?control_no=<?php echo $row4["control_no"]; ?>"><i class="ni ni-settings"></i></a></td>
