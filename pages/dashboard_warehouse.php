...
<?php
$query_page1=mysqli_query($conn, "SELECT * from tbl_pages where page_name='Warehouse' ");
...
<div class="container-fluid py-4">
                ...
                <table class="table align-items-center mb-0" id="authors-tbl"  width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase" style='height:50px;background-color:#454545;color:white'>IS Number</th>
                      ...
                      <th class="text-uppercase" style='height:50px;background-color:#454545;color:white'>total quanity</th>
                      ...
                      <?php if ($type=="Admin" || $area=="Warehouse" ){ ?>
 ...
 <div class="container-fluid py-4">
      ...
      <?php include('../modals/edit_warehouse.php'); ?><?php }else { ?><?php }	?>
