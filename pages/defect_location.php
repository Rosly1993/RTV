...
<?php $type=$_SESSION['user_role'];?>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Defect Location Info table</h6>
            </div>
      ...
      <?php if ($type=="Admin"){ ?>
      <?php include('../modals/add_defect_location.php'); ?> 

      <?php include('../modals/edit_defect_location.php'); ?><?php }else { ?><?php }	?>
      
      <?php include'../components/footer.php';?> 


      <script src="../js/defect_location.js"></script>   