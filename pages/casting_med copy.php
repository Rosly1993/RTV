        ...
        <div class="col-lg-12 mb-lg-0 mb-4">
          <div class="card ">
            ...
            <table  id="myTable" class="table align-items-center mb-0"  width="100%" cellspacing="0">
                ...
                <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" integrity="sha384-rBSKZJHM3Sb9W6f9yP1PvoH2jk9ph4WKxMQnR5r56x8u70f4wJqIfs5kM7EbxIj3" crossorigin="anonymous">

<!-- Bootstrap JS and Popper.js -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js" integrity="sha384-mQ93GR66B00ZXjt0YO5KlohRA5SY2XofP+kBIVkhB3E5IepiMDd+Xe80yJGXJqTN" crossorigin="anonymous"></script>
                  
                <div style="float: left;">
                <?php if($qty > 0 && $type=='admin' || $qty > 0 && $type=='MED-Casting') {?>
                <input type='submit'class="btn bg-gradient-success"style="width:150px" value='Accept' name='ACCEPT'>&nbsp;<input type='submit'class="btn bg-gradient-danger"style="width:140px" value='Reject' name='REJECT'>
                <?php }else { ?><?php }	?>
              </div>

              
              <td class="px-1 py-1 text-center"><a href="#" data-bs-toggle="modal" data-bs-target="#edit<?php echo $_GET['control_no']; ?>"><i class="ni ni-settings"></i></a>
...
<link href="https://cdn.datatables.net/1.13.1/js/jquery.dataTables.min.js" type='text/javascript'></script>
   ...
   $time=$datetime->format('Y-m-d H:i');
    ...
    $query = $conn->query("update  tbl_request set request_status='16', rejected_by='".$name."', date_rejected='".$time."'  where  control_no='" . $_GET['control_no'] . "' ");
