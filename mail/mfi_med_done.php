...
//get email
$query2=mysqli_query($conn, "SELECT * FROM tbl_user where is_active='1' and area='Prod-EFI' and user_role='Approver' ");
...
$mail[]=$rows2['email_address'];
       ...
       $subject = "Part's RTV Request For Note EFI-Supervisor $a";
       $body    = "";
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align='center' class='esd-block-text es-p5t es-p5b es-p40r es-p40l es-m-p0r es-m-p0l'>
                                                                                        <p>Dear User,</p>
                                                                                        <p>This is to inform you that you have for note request on Part's RTS.</p></td></tr>
                                                                                <tr>
