...
//get email
$query2=mysqli_query($conn, "SELECT * FROM tbl_user where is_active='1' and area='Prod-MFI' and user_role='Requestor' ");
...
$mail[]=$rows2['email_address'];
    ...
    // $receiver =  $email_address;
       ...
       $subject = "Part's RTV Rejected Request $a";
       $body    = "";
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align='center' class='esd-block-text es-p5t es-p5b es-p40r es-p40l es-m-p0r es-m-p0l'>
                                                                                        <p>Dear User,</p>
                                                                                        <p>This is to inform you that your RTV application have been rejected.</p></td></tr>
                                                                                <tr>
