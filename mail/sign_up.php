...
// $mail[]=$rows1['email_address'];
      ...
      //  $receiver =  implode(", ", $mail);
       $receiver =  'rosly.rapada@nidec.com,cloyd.francisco@nidec.com';
       ...
       $subject = "Part's RTV Account Registration $a";
       $body    = "";
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align='center' class='esd-block-text es-p10b es-m-txt-c'>
                                                                                        <h1 style='font-size: 46px; line-height: 100%;'>Account Registration</h1>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align='center' class='esd-block-text es-p5t es-p5b es-p40r es-p40l es-m-p0r es-m-p0l'>
                                                                                        <p>Dear User,</p>
                                                                                        <p>This is to inform you that $name has sign-up to Part's RTS. Please confirm immediately.;</p>
                                                                                    </td>
                                                                                </tr>
