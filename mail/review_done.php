...
//get email
$query2=mysqli_query($conn, "SELECT * FROM tbl_user where is_active='1' and area='MED-MFI' and user_role='Approver' ");
...
$mail[]=$rows2['email_address'];
    ...
    // $receiver =  $email_address;
       ...
       $subject = "Part's RTV Request For Note MFI-MED $a";
       $body    = "";
