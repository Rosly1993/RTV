...
//get email
$query2=mysqli_query($conn, "SELECT * FROM tbl_user where is_active='1' and area='MED-Casting' and user_role='Approver' ");
...
$mail[]=$rows2['email_address'];
    ...
    // $receiver =  $email_address;
       ...
       $subject = "Part's RTV Request For Approval Casting-MED $a";
       $body    = "";
                                                                        ...
                                                                        <table cellpadding='0' cellspacing='0' width='100%'>
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                        ...
                                                                                        <br>Approved By(Prod-Manager): &nbsp; $name
                                                                                        <br>Control #: &nbsp; $ctrl
                                                                                        <br>Model: &nbsp; $mod
