...
//  }
    ...
    //    $receiver =  implode(", ", $mail);
       ...
       $subject = "Part's RTV Account Confirmation $a";
       $body    = "";
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align='center' class='esd-block-text es-p10b es-m-txt-c'>
                                                                                        <h1 style='font-size: 46px; line-height: 100%;'>Account Confirmation</h1>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align='center' class='esd-block-text es-p5t es-p5b es-p40r es-p40l es-m-p0r es-m-p0l'>
                                                                                        <p>Dear User,</p>
                                                                                        <p>This is to inform you that your account has been $message from Part's RTS.</p></td></tr>
                                                                                <tr>
