...
//get email
$query2=mysqli_query($conn, "SELECT * FROM tbl_user where is_active='1' ");
...
$mail[]=$rows2['email_address'];
    ...
    // $receiver =  $email_address;
       ...
       $subject = "Part's RTV Request Confirmed by Casting-MED $a";
       $body    = "";
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align='center' class='esd-block-text es-p5t es-p5b es-p40r es-p40l es-m-p0r es-m-p0l'>
                                                                                        <p>Dear User,</p>
                                                                                        <p>This is to inform you that Control # - $ctrl has been corfirmed by MED-Casting.</p></td></tr>
                                                                                <tr>
                                                                                        ...
                                                                                        <br>Noted By(EFI-Sup): &nbsp; $sup
                                                                                        <br>Approved By(Prod-Manager): &nbsp; $manager
                                                                                        <br>Confirmed By(Casting-MED): &nbsp; $name
                                                                                        <br>Control #: &nbsp; $ctrl
                                                                                        <br>Model: &nbsp; $mod
