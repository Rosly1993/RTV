        ...
        authorsTbl = $('#authors-tbl').DataTable({
            ...
            drawCallback: function(settings) {
                $('.edit_data').click(function() {
                    $.ajax({
                        url: '../controller/get_single_user.php',
            ...
            buttons: [
                
                {
                    ...
                    text: '<a class="text-white addbtn"><i class="fas fa-plus text-white "></i>&nbsp; Add User</a>',
