...
$(function() {
    ...
    function load_data() {
        authorsTbl = $('#authors-tbl').DataTable({
            ...
            "pageLength": 10,
            "ajax": {
                url: "../controller/get_request.php",
                method: 'POST'
            },
            columns: [
            ...
            drawCallback: function(settings) {
                $('.edit_data').click(function() {
                    $.ajax({
                        url: '../controller/get_single_request.php',
            ...
            buttons: [
                ...
                
                {
                    ...
                    text: '<a class="text-white addbtn"><i class="fas fa-plus text-white "></i>&nbsp; Add Request</a>',
    ...
    load_data()
        ...
        $('#new_model').submit(function(e) {
            ...
            $.ajax({
                url: '../controller/save_request.php',
        ...
        $('#edit-author-frm').submit(function(e) {
            ...
            $.ajax({
                url: '../controller/cancel_request.php',
                data: $(this).serialize(),
                method: 'POST',
                dataType: "json",
                error: err => {
