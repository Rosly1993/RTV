...
$(function() {
    ...
    function load_data() {
        authorsTbl = $('#authors-tbl').DataTable({
            ...
            "pageLength": 10,
            "ajax": {
                url: "../controller/get_defect_description.php",
                method: 'POST'
            },
            columns: [
            ...
            drawCallback: function(settings) {
                $('.edit_data').click(function() {
                    $.ajax({
                        url: '../controller/get_single_description_defect.php',
            ...
            buttons: [
                ...
                
                {
                    ...
                    text: '<a class="text-white addbtn"><i class="fas fa-plus text-white "></i>&nbsp; Add Defect Location</a>',
    ...
    load_data()
        ...
        $('#new_model').submit(function(e) {
            ...
            $.ajax({
                url: '../controller/save_defect_description.php',
        ...
        $('#edit-author-frm').submit(function(e) {
            ...
            $.ajax({
                url: '../controller/update_description_defect.php',
                data: $(this).serialize(),
                method: 'POST',
                dataType: "json",
                error: err => {
