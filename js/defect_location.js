...
$(function() {
    ...
    function load_data() {
        authorsTbl = $('#authors-tbl').DataTable({
            ...
            "pageLength": 10,
            "ajax": {
                url: "../controller/get_defect_location.php",
                method: 'POST'
            },
            columns: [
            ...
            drawCallback: function(settings) {
                $('.edit_data').click(function() {
                    $.ajax({
                        url: '../controller/get_single_location_defect.php',
    ...
    load_data()
        ...
        $('#new_model').submit(function(e) {
            ...
            $.ajax({
                url: '../controller/save_defect_location.php',
        ...
        $('#edit-author-frm').submit(function(e) {
            ...
            $.ajax({
                url: '../controller/update_location_defect.php',
                data: $(this).serialize(),
                method: 'POST',
                dataType: "json",
                error: err => {
